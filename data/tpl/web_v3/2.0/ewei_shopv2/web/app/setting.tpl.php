...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <input class="form-control valid" value="<?php  echo $sec['wxapp']['mchid'];?>" <?php if(cv('app.pay.edit')) { ?> name="pay[wxapp_mchid]"<?php  } else { ?>disabled<?php  } ?> />
    </div>
</div>
<div class="form-group">
    <label class="col-lg control-label must">微信支付密钥(APIKEY)</label>
    <div class="col-sm-9">
        <input class="form-control valid" value="<?php  echo $sec['wxapp']['apikey'];?>" <?php if(cv('app.pay.edit')) { ?> name="pay[wxapp_apikey]"<?php  } else { ?>disabled<?php  } ?> />
    </div>
</div>
<div class="form-group">
