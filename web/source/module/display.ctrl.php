...
//        header('location:https://cb.faruigoule.com/web/index.php?c=site&a=entry&m=ewei_shopv2&do=web');
...
//		echo 333222;die;
//    header('location:'.url('home/welcome/account_ext',array('m'=>'ewei_shopv2')));
//    header('location:https://cb.faruigoule.com/web/index.php?c=site&a=entry&m=ewei_shopv2&do=web',array('m'=>'ewei_shopv2'));
//    die;
